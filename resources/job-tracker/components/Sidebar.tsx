...
//   };
 const toggleSidebar = () => {
    ...
    // Bounce effect for sidebar width change
    animate(
      sidebarRef.current,
      { width: [collapsed ? "5rem" : "16rem", collapsed ? "16rem" : "5rem"] },
  ...
  return (
    // <aside className="w-64 bg-white text-gray-700 flex flex-col h-screen" ref={adminRef}>
    <aside
      className={`bg-white text-gray-700 flex flex-col h-screen transition-width duration-300 ${
        collapsed ? "w-16" : "w-64"
      }`}
    >
      ...
      <div
        ref={adminRef}
        className="flex items-center gap-2 p-6 text-2xl font-bold border-b border-gray-200 cursor-pointer"
      ...
      <nav className="flex-1 p-6 space-y-2 overflow-y-auto">
        ...
        <div className="">
            <Link href="/home" className="flex items-center gap-3 p-2 rounded hover:bg-gray-200"> 
